...
entfernung = (dauer/2) * 0.03432;   //Berechnung der Entfernung in cm (Dividiert durch zwei, da nur eine Strecke berechnet wird und nich hin- und zurück, danach Multiplikation des Wertes mit der Schallgeschwindigkeit in der Einheit Zentimeter/Mikrosekunde)
